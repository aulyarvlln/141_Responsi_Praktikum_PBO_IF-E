...
import com.pbo.responsi.model.CartRepositoryMySQL;
...
public class CartController {
    ...
    public CartController() {
        this.repository = new CartRepositoryMySQL();
        this.discount = new WithDiscountStrategy();
        ...
        Runnable refreshView = () -> {
            ...
            view.showCartItems(items, subtotal, discountAmount, grandTotal, discount.getDiscountName());
        };
